...
function renderTopCreativeList(rows) {
    ...
    rows.forEach((row) => {
        ...
        rowEl.className = "py-2.5 border-t border-slate-100 first:border-t-0 flex items-center justify-between gap-3";
        rowEl.innerHTML = `
            <div>
            ...
            <div class="flex items-center gap-2 flex-shrink-0">
                <span class="text-sm font-medium text-emerald-600">NT$ ${Math.round(row.cpa).toLocaleString("zh-TW")}</span>
